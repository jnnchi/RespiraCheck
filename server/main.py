...
async def upload_audio(file: UploadFile = File(...)):
    ...
    return JSONResponse(
        content={"prediction": prediction, "spectrogram_image": spectrogram_b64}
    )
...
def read_root():
    return {
        "verification message": "This is respiracheck. No other endpoints currently available."
    }
