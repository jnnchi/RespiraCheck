...
parent_dir = "/home/yoshikuyuu/Projects/RespiraCheck/ml"
processed_audio = os.path.join(parent_dir, "data/cough_data/processed_audio")
...
for i in range(10):
    ...
    augment_proc.augment_all_audio(
        augmentations_to_perform=["TS", "PS", "FM", "TM"],
        folders_to_augment=["positive"],
        percent=percent,
        vol_shift=0,
        time_shift=ts,
        pitch_shift=ps,
